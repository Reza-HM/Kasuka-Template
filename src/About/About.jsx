      ...
      <div className="container">
        <div className="flex flex-col-reverse xl:flex-row gap-8 ">
          <div className="flex flex-col gap-6 xl:w-1/2">
            <h3 className="text-3xl font-bold">شرکت دیجیتال کاسوکا</h3>
            ...
            <ul className="max-w-xl space-y-2">
              <li className="flex items-center gap-2">
                <svg
                  ...
                  strokeWidth={1.5}
                  stroke="currentColor"
                  className="w-6 h-6 fill-main-color"
                >
                  <path
                    strokeLinecap="round"
              ...
              <li className="flex items-center gap-2">
                <svg
                  ...
                  strokeWidth={1.5}
                  stroke="currentColor"
                  className="w-12 h-12 fill-main-color"
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
          ...
          <div className="xl:w-1/2 xl:mt-16 2xl:m-0">
